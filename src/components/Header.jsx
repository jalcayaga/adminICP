        ...
        >
          ...
          <MenuItem className="p-0 hover:bg-transparent">
            ...
            >
              ...
              <div className="text-sm flex flex-col">
                <div className="flex items-center justify-between gap-4">
                  <span>Nuevo factura por aprobar</span>{" "}
                  <span className="text-[8px]">21/10/2022</span>
                </div>
                <p className="text-gray-500 text-xs">
                  Claudio, favor aprobar tu factura de...
                </p>
              </div>
            </Link>
          </MenuItem>
          ...
          <MenuItem className="p-0 hover:bg-transparent">
            ...
            >
              ...
              <div className="flex flex-col text-sm">
                <span className="text-sm">Javier Alcayaga</span>
                <span className="text-xs text-gray-500">javier@gmail.com</span>
              </div>
            </Link>
          </MenuItem>
